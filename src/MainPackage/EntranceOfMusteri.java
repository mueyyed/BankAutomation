...
protected static boolean isExist(String Ad,String Soyad , String Sifre) throws FileNotFoundException, IOException 
    {
        ...
        for(int i=0 ; i<Database.CutomerData.size(); i++)
        {
            ...
            Database.CutomerData.elementAt(i).Sifre.equals(Sifre))        
            {
             ...
             EntranceOfMusteri.Eposta=Database.CutomerData.elementAt(i).Eposta; 
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 115, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 160, -1));
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 270, 115, -1));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainPackage/bro.JPG"))); // NOI18N
