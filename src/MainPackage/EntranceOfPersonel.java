...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 60, -1));
        ...
        jLabel6.setText("L.Name");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, 67, -1));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainPackage/nature personel.jpg"))); // NOI18N
        ...
        try {
            if (isExist(AD, Soyad, Sifre))
            {
              ...
              //  jPanel1.setVisible(false); // to hide the current frame
                ...
                JOptionPane.showMessageDialog(null, "Information Not Matched", "Error warning", JOptionPane.PLAIN_MESSAGE);
            }
